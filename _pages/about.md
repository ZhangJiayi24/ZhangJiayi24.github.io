...
<ul style="list-style-type: none; padding-left: 0; margin: 0;">
 <li><em>2025.06:</em> 🎈 Great honor to have the opportunity to be a research assistant at the <strong>TEA lab</strong> at the <strong>Tsinghua University</strong> in October！</li>
...
<dd><a href=assets/files/2025IROS_MultiCaliAnything_Compressed.pdf""><strong>Multi‑Cali Anything: Dense Feature Multi‑Frame Structure‑from‑Motion for Large‑Scale Camera Array Calibration</strong></a></dd>
...
<dd><a href=assets/files/ICMLw2025_Spec_LLaVA.pdf""><strong>Spec‑LLAVA: Accelerating Vision‑Language Models with Dynamic Tree‑Based Speculative Decoding</strong></a></dd>
...
<dd><a href=assets/files/SCANet_Preprint.pdf""><strong>Segregation and Context Aggregation Network for Real‑Time Cloud Segmentation</strong></a></dd>
